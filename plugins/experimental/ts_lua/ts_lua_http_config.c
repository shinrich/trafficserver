...
typedef enum {
  ...
  TS_LUA_CONFIG_HTTP_ORIGIN_MAX_CONNECTIONS_QUEUE             = TS_CONFIG_HTTP_ORIGIN_MAX_CONNECTIONS,
  ...
  TS_LUA_CONFIG_HTTP_CACHE_MAX_DOC_SIZE                       = TS_CONFIG_HTTP_CACHE_MAX_DOC_SIZE,
...
ts_lua_var_item ts_lua_http_config_vars[] = {
  ...
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_HTTP_CACHE_MAX_DOC_SIZE),

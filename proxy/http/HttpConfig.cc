...
HttpConfig::startup()
{
  ...
  HttpEstablishStaticConfigByte(c.oride.http_host_sni_policy, "proxy.config.http.host_sni_policy");
...
HttpConfig::reconfigure()
{
  ...
  params->oride.http_host_sni_policy  = m_master.oride.http_host_sni_policy;

...
const char *SDK_Overridable_Configs[TS_CONFIG_LAST_ENTRY] = {
  ...
  "proxy.config.http.auth_server_session_private", "proxy.config.http.slow.log.threshold", "proxy.config.sslclient.verify.server","proxy.config.body_factory.template_base",

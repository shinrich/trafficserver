...
const char *SDK_Overridable_Configs[TS_CONFIG_LAST_ENTRY] = {
  ...
  "proxy.config.http.cache.open_write_fail_action", "proxy.config.http.redirect_use_orig_cache_key", "proxy.config.http.redirection_enabled", 
  "proxy.config.http.number_of_redirections", "proxy.config.http.origin_max_connections_queue"};

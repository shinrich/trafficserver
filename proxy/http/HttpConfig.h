...
struct OverridableHttpConfigParams {
  OverridableHttpConfigParams()
    : maintain_pristine_host_hdr(1), chunking_enabled(1), negative_caching_enabled(0), negative_revalidating_enabled(0),
      ...
      transaction_active_timeout_out(0), origin_max_connections(0), origin_max_connections_queue(0), connect_attempts_max_retries(0), 
      ...
      default_buffer_size_index(8), default_buffer_water_mark(32768), slow_log_threshold(0),ssl_client_verify_server(0),
      ...
      cache_open_write_fail_action(0), redirection_enabled(0),  number_of_redirections(1), redirect_use_orig_cache_key(0)
  {
  }
...
inline HttpConfigParams::HttpConfigParams()
  : proxy_hostname(NULL), proxy_hostname_len(0), server_max_connections(0), origin_min_keep_alive_connections(0),
    ...
    cluster_time_delta(0), redirection_host_no_port(0), post_copy_size(2048), ignore_accept_mismatch(0), 
    ignore_accept_language_mismatch(0), ignore_accept_encoding_mismatch(0), ignore_accept_charset_mismatch(0),
    send_100_continue_response(0), send_408_post_timeout_response(0), disallow_post_100_continue(0), parser_allow_non_http(1),
    cache_open_write_fail_action(0), autoconf_port(0), autoconf_localhost_only(0)
{
}

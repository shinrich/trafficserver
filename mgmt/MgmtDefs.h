...
struct MgmtConverter {
  // MgmtInt conversions.
  std::function<MgmtInt(void *)> get_int;
  std::function<void(void *, MgmtInt)> set_int;

  // MgmtFloat conversions.
  std::function<MgmtFloat(void *)> get_float;
  std::function<void(void *, MgmtFloat)> set_float;

  // MgmtString conversions.
  // This is a bit different because it takes ts::string_view instead of MgmtString but that's
  // worth the difference.
  std::function<ts::string_view(void *)> get_string;
  std::function<void(void *, ts::string_view)> set_string;
};

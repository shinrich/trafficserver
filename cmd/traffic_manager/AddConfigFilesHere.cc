...
initializeRegistry()
{
  ...
  registerFile("proxy.config.log.hosts_config_file", "log_hosts.config");
  registerFile("proxy.config.log.config.filename", "logging.config");
  ...
  registerFile("vaddrs.config", "vaddrs.config");
  registerFile("proxy.config.cache.control.filename", "cache.config");
  registerFile("proxy.config.icp.icp_configuration", "icp.config");
  ...
  registerFile("proxy.config.http.congestion_control.filename", "congestion.config");
  ...
  registerFile("metrics.config", "metrics.config");

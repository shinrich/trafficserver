  ...
  : our_wall_clock(0), alive_peers_count(0), reliable_server_fd(0), broadcast_fd(0), receive_fd(0)
{
  ...
  if (cluster_type != NO_CLUSTER) {
    ink_thread_create(nullptr, drainIncomingChannel_broadcast, this, 0, 0, nullptr); /* Spin drainer thread */
    ink_thread_create(nullptr, drainIncomingChannel, this, 0, 0, nullptr);           /* Spin drainer thread */
  }
  return;
